 ...
 */
const std::string UA_NAME("Tesseract");
...
#define GIT_COMMIT_ID "a7e80676104b5c90c5b5e3bfab815d55a9061052"
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (copyright_devs.find("Tesser Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Tesser Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/alphadamn/The-Tesser-Project>";
